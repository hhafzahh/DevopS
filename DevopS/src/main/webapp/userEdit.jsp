...
<div class="container col-md-6">
    <div class="card">
        <div class="card-body">
            ...
            <fieldset class="form-group">
                <label>Password</label> <input type="text" value="<c:out value='${user.password}' />" class="form-control"
                    name="password">
            </fieldset>
            <fieldset class="form-group">
            ...
            <fieldset class="form-group">
                <label> Language</label> <input type="text" value="<c:out value='${user.language}' />"
